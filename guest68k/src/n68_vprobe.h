 ...
 * guest68k/tests/test_vprobe.c is where it is exercised.
 *
 * THE ROW VOCABULARY IS SHARED WITH THE POWERPC GUEST ON PURPOSE.
 * guest/src/vprobe.c measures the same shapes on the PB1400c and
 ...
 * guest/src/peek_validate.c; this is its 68K sibling with the
