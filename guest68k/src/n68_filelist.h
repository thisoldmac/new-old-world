 ...
 * (guest/src/wire.c, serve_file_list). Checked rather than assumed, per
 ...
 * (nothing in host/Sources reads FileEntry.identity). It is the field to
 ...
 * now_files_describe (guest/src/fileshare.c), because the two consoles
