...
The initial alpha uses the PowerPC Carbon guest. NOW-68K/pre-Carbon support is
retained for future work but is not planned as an initial release artifact.
