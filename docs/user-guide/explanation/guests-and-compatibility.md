...
source_dependencies: [now-guest-ppc/CMakeLists.txt, now-guest-68k/CMakeLists.txt, docs/module-manifest.yaml]
media_ids: []
...
NOW-68K is a non-Carbon Toolbox application for the currently targeted System
...
Use [Choose the right guest](../how-to/choose-a-guest.md) for the selection
procedure and the [module index](../reference/modules/index.md) for the explicit
per-surface map.
