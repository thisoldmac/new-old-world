...
## FIXED, metal-verified on an emulator: `transitions start` could not arm, by any route (2026-08-05)
...
## FIXED, metal-verified on an emulator: a `transitions drain` reply lost its own records (2026-08-05)
