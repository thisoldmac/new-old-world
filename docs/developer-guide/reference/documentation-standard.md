...
audience: developer
lifecycle: current
authority: [mkdocs.yml, tools/docs-gate]
source_dependencies: [mkdocs.yml, tools/docs-gate, docs/requirements.txt, contract/asyncapi.yaml, docs/site-integration.yaml]
media_ids: []
