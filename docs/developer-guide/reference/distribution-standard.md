...
source_dependencies: [product/features.yaml, docs/distribution-profile.yaml, docs/developer-guide/architecture/updating.md, docs/resident-components.md, tools/docs-gate, tools/write-update-manifest.py]
media_ids: []
...
`product/features.yaml` owns which product features the active release
