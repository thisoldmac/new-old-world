...
description: The MacTCP and Toolbox sibling guest for System 7.1-era machines.
doc_type: explanation
audience: developer
lifecycle: current
authority: [now-guest-68k/src/main.c, docs/architecture.md]
source_dependencies: [now-guest-68k/src/main.c, now-guest-68k/src/commands/commands68.c, now-guest-68k/src/connection, now-guest-68k/src/core/wire68.c, docs/command-parity.md]
media_ids: []
