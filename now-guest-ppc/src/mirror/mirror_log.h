 ...
 * either: launch logs are bounded, but a line per event-loop pass would
 * still churn that bound and spend File Manager latency on a heartbeat,
 * which rule 1 forbids. Each call below compares against what it
