...
static const char *const d_chat[] = {
    ...
    "  time. Pick a model first: chat --models lists what",
    "  is configured, chat --model <key> chooses. Flags:",
    "    --models   list the other Mac's models",
    "    --model K  choose one for later turns",
...
const NowCommandDoc kNowCommandDocs[] = {
    ...
    { "chat", 0, "talk to a model through the other Mac",
      "chat <text> | chat --models | --model <key> | --new | --stop",
      d_chat },
