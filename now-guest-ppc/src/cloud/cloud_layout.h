...
typedef struct {
    ...
    Rect save_group;                  /* photos: the titled group box
                                          holding everything a save
                                          needs - size, destination,
                                          and the button. One static
                                          cluster, no disclosed state:
                                          the toggle it replaced looked
                                          identical closed and broke
                                          open (metal, 2026-08-02).
