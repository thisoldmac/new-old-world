...
/* Finder's Get Info version, and what a version-checking installer or
   ...
   NOW_PRODUCT_VERSION and lifecycle in contract/product_version.h; BCD
   0x00,0x20 is major 0, minor 2, bugfix 0. Pre-alpha maps to the
   NumVersion development stage and carries its positive sequence. */
resource 'vers' (1) {
    0x00, 0x20,
    development, 0x01,
    verUS,
    "0.2.0-prealpha.1",
    "0.2.0-prealpha.1, New Old World"
};
