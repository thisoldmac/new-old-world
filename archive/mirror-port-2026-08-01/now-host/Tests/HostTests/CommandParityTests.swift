...
final class CommandParityTests: XCTestCase {
    ...
    private static let consoleDebt: [String: String] = [
        ...
        "menugeom": "takes a menu id and, optionally, the two serial "
                + "numbers of the process that owns it - the same shape "
                + "activate takes; owed since it landed 2026-08-01 beside "
                + "key's modifier route",
    ]
