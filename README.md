...
| Projects and Development: app-owned Git history/workspaces, verified guest candidates, declarative MPW ToolServer jobs, exact-product run and optional CodeKitten handoff | yes | typed unavailable | **partly emulator-verified, not metal-verified**: an active guest project completed MPW compile/link/Rez, cancel, rebuild and exact-product launch on mac99/OS 9.1; import/stage/promote and CodeKitten handoff remain unrun, source resource forks are refused rather than lost, and Finder metadata is not yet preserved — [docs/development.md](docs/development.md) |
