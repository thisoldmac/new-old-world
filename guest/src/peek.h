...
/* The application's view of the NOW Extension - the optional resident
   component (docs/processes-and-peek.md). Four states, because an
   installer needs all four to be legible: the file can be absent,
...
enum {
    kNowPeekCapAnchors = 1 << 0,  /* plane P1: window bounds          */
    kNowPeekCapTree = 1 << 1      /* plane P2: semantic tree          */
};
