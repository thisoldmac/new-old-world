 ...
 * (now/now-guest-ppc/src/core/wire.c, on_frame_ready()); this codec makes no such
 ...
 * does (now_json_value in now/now-guest-ppc/src/core/json.c), and no differently. For
 ...
 * carries its own json_find_u32 (now/now-guest-ppc/src/core/wire.c) for exactly this,
