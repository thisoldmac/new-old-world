 ...
 * now/now-guest-ppc/src/core/wire.c and json.c. See the divergence note at the bottom
 ...
 * now-host/Sources/Host/FrameCodec.swift's maxPayloadLength and the PPC
 ...
 * the connection (now/now-guest-ppc/src/core/wire.c, on_frame_ready(), "Bigger than
