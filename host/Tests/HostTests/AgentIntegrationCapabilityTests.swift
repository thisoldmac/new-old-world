...
final class AgentIntegrationCapabilityTests: XCTestCase {
    ...
    func testNoCompanionCodeBranchesOnGuestIdentity() throws {
        ...
        let surface = [
            "host/Sources/Host/Automation/AgentIntegrationCapabilityLedger.swift",
            "host/Sources/Host/Automation/AgentIntegrationProcessControl.swift",
            "host/Sources/Host/Automation/AgentIntegrationSoftwareLaunch.swift",
            "host/Sources/Host/Automation/AgentIntegrationSessionHealth.swift",
            "host/Sources/Host/Automation/GuestFilesCommands.swift",
            "host/Sources/NOWAgentCompanion/NOWMCPServer.swift",
        ]
