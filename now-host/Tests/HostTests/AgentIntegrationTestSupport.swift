...
/// An expected result shape did not arrive. Throwing this fails the test;
/// unlike `XCTSkip`, it cannot turn a product regression into a green gate.
struct UnexpectedTestResult: Error, CustomStringConvertible {
