...
public struct SceneRenderer {
    ...
    private func drawDesktop(_ ctx: GraphicsContext, _ bounds: CGRect) {
        /* THE MACHINE FIRST, THE PACK SECOND. Until the
           ...
           asks the scene first and reports who answered. Pack provenance is
           shown in the Mirror inspector instead of burned into the guest
           surface. */
