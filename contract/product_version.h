...
/* Product maturity is separate from the numeric compatibility version and
   from a release candidate's publication iteration.  Non-release stages use
   a positive sequence.  A release uses sequence 0 and has no stage suffix. */
#define NOW_PRODUCT_LIFECYCLE "prealpha"
#define NOW_PRODUCT_LIFECYCLE_NUMBER 1
#define NOW_PRODUCT_DISPLAY_VERSION "0.2.0-prealpha.1"
