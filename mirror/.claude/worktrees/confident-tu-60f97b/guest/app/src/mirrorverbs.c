...
/* --- Portal op 5: `textget` / `textset` (lane P2, 2026-07-31) --------------
 *
                         ...
                         const char *line, size_t len)
{
    ...
    /* Appended by lane P2 (2026-07-31): Portal op 5, text read and write in
     * the application's own context. New rows go at the END. */
