...
///
/// UNSTABLE until the parity gate (MIRRORKIT-PLAN decision 5): `version` is
/// stamped from day one, but the shape churns freely during the workshop
/// maturation phase. Fixtures are regression tests, not a contract, until the
/// v1 freeze.
public struct Scene: Codable, Equatable, Sendable {
    /// IR version stamp. 0 = pre-freeze, unstable.
